(async function () {
  const widgetID = document.currentScript.getAttribute('element_id');
  const sortBy = document.currentScript.getAttribute('sort');
  ...
  function init(loadScript) {
    let baseHTML = `<div class="main-container">
        ...
        <span id="errorMsg">Failed to load medal info, please check if server is up and running.</span>
      <div class="grid-container" id="container1">
        <div class="grid-header-wrapper">
          ...
          <div class="grid-item">
          <div class="button-container" data-id="total">
